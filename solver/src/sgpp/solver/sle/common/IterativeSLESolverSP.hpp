...
#include <sgpp/solver/common/IterativeSGSolverSP.hpp>
...
class IterativeSLESolverSP : public IterativeSGSolverSP {
 public:
  /**
   * Std-Constructor
   *
   ...
   */
  IterativeSLESolverSP(size_t imax, float epsilon) : IterativeSGSolverSP(imax, epsilon) {}

  /**
   * Std-Destructor
   */
  virtual ~IterativeSLESolverSP() {}
